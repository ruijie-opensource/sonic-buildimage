...
#################风扇调速参数##############################
MONITOR_TEMP_MIN           = 35    # 调速开始温度
MONITOR_K                  = 11    # 调速策略
MONITOR_MAC_IN             = 35    # mac与芯片的温差
MONITOR_DEFAULT_SPEED      = 0x99  # 默认转速
MONITOR_MAX_SPEED          = 0xFF  # 最大转速(全转)
MONITOR_MIN_SPEED          = 0x99  # 最小转速
...
PSU_FAN_FOLLOW = {
    "psu1":{"bus":7, "loc":0x58, "offset1":0x3a, "value1":0x80, "offset2":0x3b, "gettype":"i2c"},
    "psu2":{"bus":8, "loc":0X5B, "offset1":0x3a, "value1":0x80, "offset2":0x3b, "gettype":"i2c"},
}
...
DRIVERLISTS = [
        ...
        {"name": "rg_of_i2c_client_drv", "delay": 0},
        {"name": "rg_dts_drv path=/etc/dts/b6510_48vs8cq.dtb", "delay": 0, "removable":0},
...
DEVICE = [
        {"name":"rg_lm75","bus": 2,   "loc":0x48 },
        {"name":"rg_lm75","bus": 2,   "loc":0x49 },
        {"name":"rg_lm75","bus": 2,   "loc":0x4a },
        ...
        {"name":"rg_dps550","bus":7 ,"loc":0x58 },
        {"name":"rg_psu","bus":8 ,"loc":0x53 },
        {"name":"rg_dps550","bus":8 ,"loc":0x5b },
]

OPTOE = [
        {"name": "optoe2", "startbus": 11, "endbus": 58},
        {"name": "optoe1", "startbus": 59, "endbus": 66},
]
