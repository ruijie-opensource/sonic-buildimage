...
def get_value_once(config):
    try:
        ...
        if way == 'sysfs':
            ...
            return rjpcird(pcibus, slot, fn, bar, offset, data)
        elif way == 'bit_rd':
...
def set_value_once(config):
    try:
        ...
        if way == 'sysfs':
            ...
            offset = config.get("offset")
            data = config.get("data")
            return rjpciwr(pcibus, slot, fn, bar, offset, data)
        else:
