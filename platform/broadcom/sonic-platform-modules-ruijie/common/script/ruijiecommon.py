...
MONITOR_PID_FLAG = 0  # 1 进行PID调速; 0 不进行PID调速
...
MAC_AVS_SYSFS_DEFAULT_PARAM = {
    ...
    "set_avs": {"loc": "/sys/bus/i2c/devices/2-0060/avs0_vout_command", "gettype": "sysfs"},
}
#####################MAC调压参数####################################
