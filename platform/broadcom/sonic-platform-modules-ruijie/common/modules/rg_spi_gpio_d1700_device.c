...
#define DEFAULT_GPIO_SCK        (55)
#define DEFAULT_GPIO_MISO       (54)
#define DEFAULT_GPIO_MOSI       (52)
#define DEFAULT_GPIO_CS         (53)
...
static struct gpiod_lookup_table rg_spi_gpio_table = {
    .table          = {
        GPIO_LOOKUP("INTC3001:00", DEFAULT_GPIO_SCK,
                "sck", GPIO_ACTIVE_HIGH),
        GPIO_LOOKUP("INTC3001:00", DEFAULT_GPIO_MOSI,
                "mosi", GPIO_ACTIVE_HIGH),
        GPIO_LOOKUP("INTC3001:00", DEFAULT_GPIO_MISO,
                "miso", GPIO_ACTIVE_HIGH),
        GPIO_LOOKUP("INTC3001:00", DEFAULT_GPIO_CS,
                "cs", GPIO_ACTIVE_HIGH),
        { },
    },
};
