...
/*
 * rg_get_psu_vendor - Used to get psu model name,
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_vendor(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_get_psu_date - Used to get psu date,
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_date(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_get_psu_status - Used to get psu status,
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_status(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_get_psu_alarm - Used to get psu alarm status,
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_alarm(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_get_psu_status_pmbus - Used to get psu status from pmbus
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_status_pmbus(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_get_psu_fan_speed_max - Used to get psu fan speed max
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_fan_speed_max(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;

    check_p(g_drv);
    check_p(g_drv->get_psu_fan_speed_max);

    ret = g_drv->get_psu_fan_speed_max(psu_index, buf, count);
    return ret;
}

/*
 * rg_get_psu_fan_speed_min - Used to get psu fan speed min
 * filled the value to buf
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_fan_speed_min(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;

    check_p(g_drv);
    check_p(g_drv->get_psu_fan_speed_min);

    ret = g_drv->get_psu_fan_speed_min(psu_index, buf, count);
    return ret;
}

/*
 * rg_get_psu_fan_out_vol_max - Used to get psu fan out_vol max
 * filled the value to buf
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_fan_out_vol_max(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;

    check_p(g_drv);
    check_p(g_drv->get_psu_out_vol_max);

    ret = g_drv->get_psu_out_vol_max(psu_index, buf, count);
    return ret;
}

/*
 * rg_get_psu_fan_out_vol_min - Used to get psu fan out_vol min
 * filled the value to buf
 * @psu_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_psu_fan_out_vol_min(unsigned int psu_index, char *buf, size_t count)
{
    ssize_t ret;

    check_p(g_drv);
    check_p(g_drv->get_psu_out_vol_min);

    ret = g_drv->get_psu_out_vol_min(psu_index, buf, count);
    return ret;
}
...
static struct s3ip_sysfs_psu_drivers_s drivers = {
    ...
    .get_psu_vendor = rg_get_psu_vendor,
    .get_psu_date = rg_get_psu_date,
    .get_psu_status = rg_get_psu_status,
    .get_psu_alarm = rg_get_psu_alarm,
    ...
    .get_psu_status_pmbus = rg_get_psu_status_pmbus,
    ...
    .get_psu_fan_speed_max = rg_get_psu_fan_speed_max,
    .get_psu_fan_speed_min = rg_get_psu_fan_speed_min,
    .get_psu_out_vol_max = rg_get_psu_fan_out_vol_max,
    .get_psu_out_vol_min = rg_get_psu_fan_out_vol_min,
};
