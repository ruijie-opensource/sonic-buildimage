...
/*
 * rg_get_slot_vendor - Used to get slot model name,
 * @slot_index: start with 1
 * @buf: Data receiving buffer
 * @count: length of buf
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_slot_vendor(unsigned int slot_index, char *buf, size_t count)
{
    ssize_t ret;
...
/*
 * rg_set_slot_power_status - Used to set slot power status,
 * filled the value to buf, slot status define as below:
 * 0: OFF
 * 1: ON
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static int rg_set_slot_power_status(unsigned int slot_index, int status)
{
    int ret;
...
/*
 * rg_get_slot_power_status - Used to get slot power status,
 * filled the value to buf, slot status define as below:
 * 0: OFF
 * 1: ON
 *
 ...
 * otherwise it returns a negative value on failed.
 */
static ssize_t rg_get_slot_power_status(unsigned int slot_index, char *buf, size_t count)
{
    ssize_t ret;
...
static struct s3ip_sysfs_slot_drivers_s drivers = {
    ...
    .get_slot_vendor = rg_get_slot_vendor,
    ...
    .get_slot_power_status = rg_get_slot_power_status,
    .set_slot_power_status = rg_set_slot_power_status,
