...
static ssize_t rg_get_eth_optoe_type(unsigned int sff_index, int *optoe_type)
{
    ssize_t ret;
    ...
    ret = g_drv->get_eth_optoe_type(sff_index, optoe_type);
    return ret;
}

static ssize_t rg_set_eth_optoe_type(unsigned int sff_index, int optoe_type)
{
    ssize_t ret;
...
static struct s3ip_sysfs_transceiver_drivers_s drivers = {
    ...
    .get_eth_optoe_type = rg_get_eth_optoe_type,
    .set_eth_optoe_type = rg_set_eth_optoe_type,
};
