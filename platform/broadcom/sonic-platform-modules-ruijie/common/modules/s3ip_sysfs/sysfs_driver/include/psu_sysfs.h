...
struct s3ip_sysfs_psu_drivers_s {
    ...
    ssize_t (*get_psu_fan_speed_max)(unsigned int psu_index, char *buf, size_t count);
    ssize_t (*get_psu_fan_speed_min)(unsigned int psu_index, char *buf, size_t count);
    ssize_t (*get_psu_out_vol_max)(unsigned int psu_index, char *buf, size_t count);
    ssize_t (*get_psu_out_vol_min)(unsigned int psu_index, char *buf, size_t count);
