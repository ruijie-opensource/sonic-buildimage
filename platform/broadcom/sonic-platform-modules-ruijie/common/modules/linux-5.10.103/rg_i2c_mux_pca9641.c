...
#define PCA9641_RESET_DELAY    (150)        /* 9641解复位之后, 延时150us才能正常访问 */
...
static const struct of_device_id pca9541_of_match[] = {
    { .compatible = "ruijie,rg_pca9541" },
    { .compatible = "ruijie,rg_pca9641" },
    {}
};
