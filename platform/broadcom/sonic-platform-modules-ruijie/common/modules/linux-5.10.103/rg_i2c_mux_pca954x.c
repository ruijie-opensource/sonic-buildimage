...
static const struct of_device_id pca954x_of_match[] = {
    { .compatible = "ruijie,rg_pca9540", .data = &chips[pca_9540] },
    { .compatible = "ruijie,rg_pca9542", .data = &chips[pca_9542] },
    { .compatible = "ruijie,rg_pca9543", .data = &chips[pca_9543] },
    { .compatible = "ruijie,rg_pca9544", .data = &chips[pca_9544] },
    { .compatible = "ruijie,rg_pca9545", .data = &chips[pca_9545] },
    { .compatible = "ruijie,rg_pca9546", .data = &chips[pca_9546] },
    { .compatible = "ruijie,rg_pca9547", .data = &chips[pca_9547] },
    { .compatible = "ruijie,rg_pca9548", .data = &chips[pca_9548] },
    {}
};
...
static int pca954x_deselect_mux(struct i2c_mux_core *muxc, u32 chan)
{
    ...
    data->last_chan = 0;
    if (data->pca9548_cfg_info.close_chan_force_reset) { /* 强制复位9548, 关通道 */
    ...
    /* 9641权限需要在9548复位之后释放，重新关一次通道确保9641权限立即释放 */
             ...
             const struct i2c_device_id *id)
{
    ...
    for (num = 0; num < data->chip->nchans; num++) {
        ...
        if (dynamic_nr == 1) {
            ...
            force = data->pca9548_cfg_info.pca9548_base_nr + num;    /* 指定i2c bus */
        }
