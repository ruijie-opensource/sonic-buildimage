#ifndef __RG_I2C_MUX_PCA9641_H__
#define __RG_I2C_MUX_PCA9641_H__

typedef enum pca9641_reset_type_s {
    PCA9641_RESET_NONE = 0,     /* 不需要9641复位 */
    PCA9641_RESET_I2C = 1,      /* 通过I2C接口复位9641 */
    PCA9641_RESET_GPIO = 2,     /* 通过GPIO复位9641 */
    PCA9641_RESET_IO = 3,       /* 通过io接口复位9641 */
    PCA9641_RESET_FILE = 4,     /* 通过文件接口复位9641 */
...
typedef struct i2c_mux_pca9641_device_s {
    ...
    uint32_t pca9641_nr;                    /* base bus号 */
    uint32_t pca9641_reset_type;            /* 数据位宽 */
