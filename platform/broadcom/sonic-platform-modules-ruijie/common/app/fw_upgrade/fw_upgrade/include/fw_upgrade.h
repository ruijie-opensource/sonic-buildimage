...
#define CHIP_ERASE_TIME             (60)                /* 整片擦除等待60s */
#define CHIP_ERASE_TIMEOUT          (300 * 1000 * 1000) /* 轮询整片擦除超时时间300s */
#define CHIP_ERASE_SLEEP_TIME       (5 * 1000 * 1000)   /* 轮询整片擦除睡眠时间5s */
#define BLOCK_ERASE_TIMEOUT         (10 * 1000 * 1000)  /* 轮询块擦除超时时间10s */
#define BLOCK_ERASE_SLEEP_TIME      (100 * 1000)        /* 轮询块擦除睡眠时间100ms */
#define PAGE_PROGRAM_TIMEOUT        (100 * 1000)        /* 轮询page program超时时间100ms */
#define PAGE_PROGRAM_SLEEP_TIME     (1000)              /* 轮询page program睡眠时间1ms */
#define FLASH_WEL_TIMEOUT           (100 * 1000)        /* 轮询写使能状态超时时间100ms */
#define FLASH_WEL_SLEEP_TIME        (1000)              /* 轮询写使能状态睡眠时间1ms */
