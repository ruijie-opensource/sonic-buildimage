...
/*
 * platform_simple_get_mem_space - 获取内存测试的空间
 * @buf: 起始地址指针
 * @size: 空间大小
 * 
...
find:
    ...
    /* 获取可生产测试的MTD设备名的编号，设备名和设备分区大小分隔符为冒号  */
    c = ':';
...
/*
 * platform_get_mem_space - 获取内存测试的空间
 * @buf: 获取到的起始地址指针
 * @size: 空间大小
 *
...
/*
 * platform_free_mem_space - 释放内存测试申请的内存
 * 
 * Return void:
 */
...
/**
 * platform_complex_sys_memory_test - 内存测试
 * @sdram_test: 输出，内存测试结果明细
 * @kaoji: 输入，当前是否拷机 * 
 * Return int: FAC_TEST_FAIL | FAC_TEST_OK
 */
