 ...
 */
/*
 * firmware_cpld_upgrade_ispvme.c
 * Original Author :  sonic_rd@ruijie.com.cn 2021-01-22
 *
 */
...
/*
 * tap_send_instruction  
 * function:Send instructions to the device¤
 * @instruction: param[in] Instruction to be sent
 * @ins_len: param[in]     Instruction length
 */
 ...
 * @data: param[in] Data that needs to be sent
 * @data_len: param[in] The length of the data
 */
...
/* 
 * cpld_read_buffer
 * function:Read the contents of CPLD®¹
 * @chip: param[in]    chip index
 * @size: param[in]    Read Size
 * @buffer: param[out] Data point
 */
...
/* 
 * upgrade_str_hex_to_dec 
 * function: A hexadecimal string is converted to a decimal value. 
            Converts the string before the end flag to a decimal value
 * @str: param[in]A hexadecimal string
 * @end_char: param[in] The end of the character¬¦
 * return value: Returns a decimal value on success, or an error code on failure */
...
/*
 * cpld_check_upgrade_data -
 * function: Take the CPLD chip upgrade data information,
             remove the redundant information in the CPLD upgrade file, 
             and get the available data information of CPLD upgrade
 * @src: param[in]  CPLD file contents®¹
 * @src_len: param[in] CPLD file content length
 * @dst_len: param[in] The length of content that the CPLD chip can recognize
 * @dst: param[out] Store the content that the CPLD chip can recognize®¹
 */
