...
devices = {
    ...
    "fans": [
        {
            "name": "FAN1",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-75/75-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
        ...
        },
        {
            "name": "FAN2",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-74/74-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
        ...
        },
        {
            "name": "FAN3",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-73/73-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
        ...
        },
        {
            "name": "FAN4",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-72/72-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
        ...
        },
        {
            "name": "FAN5",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-71/71-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
        ...
        },
        {
            "name": "FAN6",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-70/70-0050/eeprom', 'offset': 0, 'len': 256, 'way': 'devfile'},
    ...
    "dcdc": [
        ...
        },
        {
            ...
            "dcdc_id": "DCDC25",
            "value": {
                "loc": "/sys/bus/i2c/devices/65-0067/hwmon/*/in4_input",
                "way": "sysfs",
            },
            "read_times": 1,
            "Min": 882,
        ...
        },
        {
            ...
            "dcdc_id": "DCDC27",
            "value": {
                "loc": "/sys/bus/i2c/devices/65-006c/hwmon/*/in4_input",
                "way": "sysfs",
            },
            "read_times": 1,
            "Min": 855,
