...
static fpga_i2c_bus_device_t fpga1_i2c_bus_device_data6 = {
    .adap_nr                 = 26,
    .i2c_timeout             = 3000,
    .i2c_scale               = 0x1800,
    .i2c_filter              = 0x1804,
...
static fpga_i2c_bus_device_t fpga1_i2c_bus_device_data7 = {
    .adap_nr                 = 27,
    .i2c_timeout             = 3000,
    .i2c_scale               = 0x1900,
    .i2c_filter              = 0x1904,
...
static struct platform_device fpga_i2c_bus_device[] = {
    ...
    },
    {
        ...
        .id = 25,
        .dev    = {
            .platform_data  = &fpga1_i2c_bus_device_data6,
            .release = rg_fpga_i2c_bus_device_release,
        },
    },
    {
        ...
        .id = 26,
        .dev    = {
            .platform_data  = &fpga1_i2c_bus_device_data7,
            .release = rg_fpga_i2c_bus_device_release,
        },
    },
    {
